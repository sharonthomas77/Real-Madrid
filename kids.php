                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_he17412_20210307063031.jpg" height="500" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item" data-bs-interval="2000">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_av12303_20210313062020.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_he19612_20210313064022.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color:floralwhite;"></h5>
                            <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: floralwhite;"></p>
                        </div>
                ...
                <table class="table table-borderless">
                    <tr>
                        <td>
                         ...
                         <img src="https://www.realmadrid.com/img/vertical_220px/carvajal_380x501_20201203095829.jpg" class="card-img-top" alt="...">
                                 <div class="card-body">
                                 <h5 class="card-title">CARVAJAL</h5>
                                 <p class="card-text">
                                 </div>
                                </div></td>
                                <td><div class="card" style="width: 18rem;">
                                 <img src="https://www.realmadrid.com/img/vertical_220px/ramos_380x501_20201203095830.jpg"  class="card-img-top" alt="...">
                                 <div class="card-body">
                                 ...
                                 <p class="card-text">
                                  ...
                                  <td><div class="card" style="width: 18rem;">
                                  <img src="https://www.realmadrid.com/img/vertical_220px/varane_380x501_20201203095831.jpg" class="card-img-top" alt="...">
                                  <div class="card-body">
                                 <h5 class="card-title">R.VARANE</h5>
                                 <p class="card-text">
                                 </p>
                                 </div>
                                  </div>
                          ...
                          <tr>
                                <td>
                        <div class="card" style="width: 18rem;">
                        <img src="https://www.realmadrid.com/img/vertical_220px/nacho_380x501_20201203095831.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                       ...
                       <td>
                      <div class="card" style="width: 18rem;">
                      <img src="https://www.realmadrid.com/img/vertical_220px/marcelo_380x501_20201203095832.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                      ...
                      <td>
                      <div class="card" style="width: 18rem;">
                      <img src="https://www.realmadrid.com/img/vertical_220px/militao_380x501_20201203095858.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                      <h5 class="card-title">E.MILITAO</h5>
                      <p class="card-text">
                      </p>
                      </div></td>
                     </tr>
                     ...
                     <tr>
                        <td>
                            ...
                            <img src="https://www.realmadrid.com/img/vertical_220px/nacho_380x501_20201203095831.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                            <h5 class="card-title">F.MENDY</h5>
                            <p class="card-text">
                            </p>
                            </div></td>                       
                          ...
                          <td>
                          <div class="card" style="width: 18rem;">
                          <img src="https://www.realmadrid.com/img/vertical_220px/odriozola_380x501_20201203095852.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                          <h5 class="card-title">ODRIOZOLA</h5>
                          <p class="card-text">
                          </p>
                          </div></td>
                         </tr>
