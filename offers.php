                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                        <img src="c.jpg" height="500" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item" data-bs-interval="2000">
                        <img src="d.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">                            
                      ...
                      <div class="carousel-item">
                        <img src="e.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color:floralwhite;"></h5>
                            <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: floralwhite;"></p>
                        </div>
                ...
                <table class="table table-borderless">
                    <tr>
                      <td>
                        ...
                        <img src="https://www.realmadrid.com/cs/Satellite?blobcol=urldata&blobheader=image%2Fjpeg&blobkey=id&blobtable=MungoBlobs&blobwhere=1203412332527&ssbinary=true" class="card-img-top" alt="...">
                                <div class="card-body">
                                <h5 class="card-title">PRESIDENT</h5>
                                <h4 class="card-title">FLORENTINO PÉREZ RODRÍGUEZ</h4>
                        ...
                        <td>
                         <div class="card" style="width: 18rem;">
                         <img src="https://www.realmadrid.com/cs/Satellite?blobcol=urldata&blobheader=image%2Fjpeg&blobkey=id&blobtable=MungoBlobs&blobwhere=1203385928419&ssbinary=true" class="card-img-top" alt="...">
                                 <div class="card-body">
                                 <h5 class="card-title">VICE PRESIDENT</h5>
                                 <h4 class="card-title">FERNANDO FERNÁNDEZ TAPIAS</h4>

                                 <p class="card-text">
                                 </div>
                                </div></td>
                                <td><div class="card" style="width: 18rem;">
                                 <img src="https://www.realmadrid.com/cs/Satellite?blobcol=urldata&blobheader=image%2Fjpeg&blobkey=id&blobtable=MungoBlobs&blobwhere=1203374979809&ssbinary=true"  class="card-img-top" alt="...">
                                 <div class="card-body">
                                 <h5 class="card-title">SECRETERY</h5>
                                 <h4 class="card-title">ENRIQUE SÁNCHEZ GONZÁLEZ</h4>
                                 ...
                                 <img src="https://upload.wikimedia.org/wikipedia/commons/f/f3/Zinedine_Zidane_by_Tasnim_03.jpg"  class="card-img-top" height="360" alt="...">
                                 <h5 class="card-title">MANAGER</h5>
                                 <h4 class="card-title">ZINADINE ZIDANE</h4>
                                 <p class="card-text">
                                 </p>
                                 </div>
                                  </div>
