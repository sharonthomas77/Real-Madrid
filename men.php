                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_he12748_20210220110048.jpg" height="500" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item" data-bs-interval="2000">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_he12403_20210220093554.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img src="https://www.realmadrid.com/img/galeria-marca/gettyimages-1231289725_20210220110050.jpg" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color:floralwhite;"></h5>
                            <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: floralwhite;"></p>
                        </div>
                ...
                <table class="table table-borderless">
                    <tr>
                        <td>
                         ...
                         <img src="https://www.realmadrid.com/img/vertical_220px/asensio_380x501_20201203095827.jpg" class="card-img-top" alt="...">
                                 <div class="card-body">
                                 <h5 class="card-title">ASENSIO</h5>
                                 <p class="card-text"></p>
                                 </div>
                                </div></td>
                                <td><div class="card" style="width: 18rem;">
                                 <img src="https://www.realmadrid.com/img/vertical_220px/benzema_380x501_20201203095836.jpg"  class="card-img-top" alt="...">
                                 <div class="card-body">
                                 ...
                                 <p class="card-text">
                                  ...
                                  <td><div class="card" style="width: 18rem;">
                                  <img src="https://www.realmadrid.com/img/vertical_220px/hazard_380x501_20201203095855.jpg" card-img-top" alt="...">
                                  <div class="card-body">
                    ...
                    <td>
                        <div class="card" style="width: 18rem;">
                        <img src="https://www.realmadrid.com/img/vertical_220px/vinicius_380x501_20201203095853.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                       ...
                       <td>
                      <div class="card" style="width: 18rem;">
                      <img src="https://www.realmadrid.com/img/vertical_220px/jovic_380x501_20201203095854.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                      <h5 class="card-title">JOVIC</h5>
                      <p class="card-text">
                      </p>
                      </div></td>
                      <td>
                      <div class="card" style="width: 18rem;">
                      <img src="https://www.realmadrid.com/img/vertical_220px/lucas_380x501_20201203095836.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                      <h5 class="card-title">LUCAS V</h5>
                      <p class="card-text">
                      </p>
                      </div></td>
                     </tr>
                     ...
                     <tr>
                        <td>
                            <div class="card" style="width: 18rem;">
                            <img src="https://www.realmadrid.com/img/vertical_220px/mariano_380x501_20201203095829.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                          ...
                          <td>
                          <div class="card" style="width: 18rem;">
                          <img src="https://www.realmadrid.com/img/vertical_220px/rodrygo_380x501_20201203095856.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                          <h5 class="card-title">RODRYGO</h5>
                          <p class="card-text">
                          </p>
                          </div></td>
                         </tr>
