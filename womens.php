                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_av17473_20210307060920.jpg" height="500" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item" data-bs-interval="2000">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_he29783_20210307043531.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img src="https://www.realmadrid.com/img/galeria-marca/_he17329_20210307064040.jpg" height="500" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color:floralwhite;"></h5>
                            <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: floralwhite;"></p>
                        </div>
                ...
                <table class="table table-borderless">
                    <tr>
                        <td>
                         ...
                         <img src="https://www.realmadrid.com/img/vertical_220px/kroos_380x501_20201203095832.jpg" class="card-img-top" alt="...">
                                 <div class="card-body">
                                 <h5 class="card-title">KROOS</h5>
                                 <p class="card-text">
                                 </div>
                                </div></td>
                                <td><div class="card" style="width: 18rem;">
                                 <img src="https://www.realmadrid.com/img/vertical_220px/modric_380x501_20201203095835.jpg"  class="card-img-top" alt="...">
                                 <div class="card-body">
                                 <h5 class="card-title">MODRIC</h5>
                                 <p class="card-text">
                                 </div>
                                 </div></td>
                                  <td><div class="card" style="width: 18rem;">
                                  <img src="https://www.realmadrid.com/img/vertical_220px/casemiro_380x501_20201203095834.jpg" card-img-top" alt="...">
                                  <div class="card-body">
                                 <h5 class="card-title">CASEMIRO</h5>
                                 <p class="card-text">
                                 </p>
                                 </div>
                          </div></td>
                    ...
                    <td>
                        <div class="card" style="width: 18rem;">
                        <img src="https://www.realmadrid.com/img/vertical_220px/valverde_380x501_20201203095828.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                       ...
                       <td>
                      <div class="card" style="width: 18rem;">
                      <img src="https://www.realmadrid.com/img/vertical_220px/odegaard_380x501_20201203095833.jpg" height="380" class="card-img-top" alt="...">
                      <div class="card-body">
                      <h5 class="card-title">ODEGAARD</h5>
                      <p class="card-text">
                      </p>
                      </div></td>
                      <td>
                      <div class="card" style="width: 18rem;">
                      <img src="https://www.realmadrid.com/img/vertical_220px/isco_380x501_20201203095835.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                      <h5 class="card-title">ISCO</h5>
                      <p class="card-text">
                      </p>
                      </div></td>
                     </tr>
